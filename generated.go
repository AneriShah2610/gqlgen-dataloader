...
type ComplexityRoot struct {
	...
	Mutation struct {
		NewApplication    func(childComplexity int, input NewApplication) int
		DeleteApplication func(childComplexity int, id string) int
		UpdateApplication func(childComplexity int, id string, input UpdateApplication) int
	}
...
type MutationResolver interface {
	NewApplication(ctx context.Context, input NewApplication) (Application, error)
	DeleteApplication(ctx context.Context, id string) (string, error)
	UpdateApplication(ctx context.Context, id string, input UpdateApplication) (Application, error)
}
type QueryResolver interface {
	Applications(ctx context.Context) ([]Application, error)
}

func field_Mutation_newApplication_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
...
func field_Mutation_updateApplication_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	args["id"] = arg0
	var arg1 UpdateApplication
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg1, err = UnmarshalUpdateApplication(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Application.details":
		if e.complexity.Application.Details == nil {
			break
		}

		return e.complexity.Application.Details(childComplexity), true
	...
	case "Mutation.newApplication":
		if e.complexity.Mutation.NewApplication == nil {
			break
		}

		args, err := field_Mutation_newApplication_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.NewApplication(childComplexity, args["input"].(NewApplication)), true
	...
	case "Mutation.updateApplication":
		...
		return e.complexity.Mutation.UpdateApplication(childComplexity, args["id"].(string), args["input"].(UpdateApplication)), true
...
func (ec *executionContext) _Application(ctx context.Context, sel ast.SelectionSet, obj *Application) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "details":
			out.Values[i] = ec._Application_details(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "createdBy":
			out.Values[i] = ec._Application_createdBy(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
// nolint: vetshadow
func (ec *executionContext) _Application_details(ctx context.Context, field graphql.CollectedField, obj *Application) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Application",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Application_createdBy(ctx context.Context, field graphql.CollectedField, obj *Application) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Application",
		Args:   nil,
		Field:  field,
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "newApplication":
			out.Values[i] = ec._Mutation_newApplication(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_newApplication(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().NewApplication(rctx, args["input"].(NewApplication))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
func (ec *executionContext) _Mutation_updateApplication(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateApplication(rctx, args["id"].(string), args["input"].(UpdateApplication))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
func UnmarshalUpdateApplication(v interface{}) (UpdateApplication, error) {
...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "schema.graphql", Input: `type Application {
    id: ID!
    name: String!
    details: String!
    createdBy: String!
